...
<!-- Page Title START -->
<div class="page-title-section" style="background-image: url('img/advantages2.jpg');">
	<div class="black-overlay-70"></div>
	<div class="container">
		<h1>Astral Advantages</h1><br>
		<p>Specialised Sterile Formulation for Strategic Alliance.</p>
	</div>
</div>
<!-- Page Title END -->
<!-- Serive Start -->
<div class="section-wrapper section-wrapper--gray">
	...
	<div class="container">
      <div class="row">
      <div class="col-12">
        <h2 class="textcolor">The Astral Advantage</h2> 
          <hr class="title1-hr">
    <p>Quality Control and Product Development facilties Facilities.</p> 
          <div class="advantage01">
       <div class="border-1"><br></div>
          <div class="border-2"><br></div>
          <div class="border-3"><br></div>
       <div class="border-4"><br></div>
          <div class="border-5"><br></div>
          <div class="border-6"><br></div>
...
<!--            <img class="center" src="img/advantage.png" width="60%">-->
          ...
          <div class="col-12">
              <img src="img/Astral%20Advantage%201.png">
              </div>          </div>
        </div> 
    ...
    <div class="col-12">
        <img src="img/Astral%20Advantage%20Mobile.png">
        </div>
    </div>
    </div>
